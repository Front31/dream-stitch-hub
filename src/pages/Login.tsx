...
const Login = () => {
  ...
  const handleSendCode = async (e: React.FormEvent) => {
    ...
    // TODO: Integrate with Shopify New Customer Accounts API
    // This would call the Shopify customer account API to send a verification code
    await new Promise((r) => setTimeout(r, 800));
    setIsLoading(false);
    setStep('code');
    toast({
      title: 'Code gesendet',
      description: `Ein Bestätigungscode wurde an ${email} gesendet.`,
    });
  };
  ...
  const handleVerifyCode = async (value: string) => {
    ...
    // TODO: Integrate with Shopify New Customer Accounts API
    // This would verify the code and create a customer session
    await new Promise((r) => setTimeout(r, 800));
    setIsLoading(false);
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground text-sm mt-2">
              {step === 'email'
                ? 'Gib deine E-Mail-Adresse ein, um dich anzumelden oder ein Konto zu erstellen.'
