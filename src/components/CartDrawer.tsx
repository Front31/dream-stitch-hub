  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetTrigger asChild>
        <Button variant="outline" size="icon" className="relative bg-background/80 backdrop-blur-sm border-primary/20 hover:border-primary/40">
      ...
      <SheetContent className="w-full sm:max-w-lg flex flex-col h-full">
        <SheetHeader className="flex-shrink-0">
          ...
          <SheetDescription>
            {totalItems === 0 ? t('cart.empty') : t('cart.items', { count: totalItems.toString() })}
          </SheetDescription>
        </SheetHeader>
